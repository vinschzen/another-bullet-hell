...
public class EchoWavebomb : BaseWeapon
{
    ...
    public EchoWavebomb() : base("Echo Wavebomb", 10, 0.1f, 0.05f, 20, 1)
    {
    }
    ...
    public override void Fire(Transform bulletSpawn)
    {
        ...
        bullet.GetComponent<EnemyWaveBombController>().activate = true;
